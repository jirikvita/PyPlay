...
for gr_case, gr_death, tag, lst in zip(gr_cases, gr_deaths, tags, lsts):
    ...
    if ig in toFitIndices:
        ...
        fit_case.SetParameters(1.e2, 0.01)
        ...
        fit_case2.SetParameters(1.e2, 0.01)
...
ROOT.gPad.SetLogy()
h2.GetYaxis().UnZoom()
# legFit = ROOT.TLegend(0.55, 0.12, 0.88, 0.45)
legFit.SetX1NDC(0.55)
legFit.SetY1NDC(0.12)
legFit.SetX2NDC(0.88)
legFit.SetY2NDC(0.45)
ROOT.gPad.Update()
