...
class cworld:
  # code generated by PrintGettersAndSetters.py
  def __init__(self, can, day, step, xmin, xmax, ymin, ymax, nPeople, rand, randSpeedX, randSpeedY, cols, marks, attractorIndex):
    self._can = can
    self._day = day
    self._step = step
    self._xmin = xmin
...
class cparams:
  # code generated by PrintGettersAndSetters.py
  def __init__(self, spreadFrequency, spreadRadius, dieProb, healProb, getWellTime, incubationTime, superSpreadFraction, initialSickFraction, maxDaysSick):
